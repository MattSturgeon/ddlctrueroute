...
label ch12_play:
    ...
    if monika_type == 0:
        ...
        m 1g "I don't even know if you'll get to use those numbers..."
        m "If you do, I hope you figure out what they mean."
        m "I'll be doing all I can to help as well..."
        m "But I doubt that's enough for what's coming."
